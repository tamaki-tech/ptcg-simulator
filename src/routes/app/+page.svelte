<script lang="ts">
  ...
  import TrashArea from "./components/Areas/TrashArea.svelte";
  ...
  $: trashArea = $state.context.trashArea;
...
{:else}
  ...
  <section class="flex flex-col h-screen overflow-auto gap-2 p-2">
    ...
    <section class="grid grid-rows-2 grid-cols-5 gap-2">
